    ...
    private void dispenseItem(World par1World, int par2, int par3, int par4, Random par5Random)
    {
        ...
        if (var11 != null)
        {
            ...
            else
            {
                ...
                int var20 = func_72283_a(var11, par1World, var19, par5Random, par2, par3, par4, var9, var10, var13, var15, var17);
                ...
                else if (var20 == 0)
                {
                    ...
                    func_72282_a(par1World, var19, par5Random, 6, var9, var10, var13, var15, var17);
    ...
    private static int func_72283_a(TileEntityDispenser par0TileEntityDispenser, World par1World, ItemStack par2ItemStack, Random par3Random, int par4, int par5, int par6, int par7, int par8, double par9, double par11, double par13)
    {
        ...
        else if (par2ItemStack.itemID != Item.bucketLava.shiftedIndex && par2ItemStack.itemID != Item.bucketWater.shiftedIndex)
        {
            if (par2ItemStack.itemID == Item.bucketEmpty.shiftedIndex)
            {
                ...
                {
                    par1World.setBlockWithNotify(var23, par5, var18, 0);
