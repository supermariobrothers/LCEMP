...
public class Explosion
{
    ...
    public void doExplosionA()
    {
        ...
        List var9 = this.worldObj.getEntitiesWithinAABBExcludingEntity(this.exploder, AxisAlignedBB.getAABBPool().addOrModifyAABBInPool((double)var3, (double)var5, (double)var7, (double)var4, (double)var27, (double)var28));
        Vec3 var29 = Vec3.func_72437_a().func_72345_a(this.explosionX, this.explosionY, this.explosionZ);
        ...
        for (int var11 = 0; var11 < var9.size(); ++var11)
        {
            ...
            if (var13 <= 1.0D)
            {
                ...
                double var31 = (double)MathHelper.sqrt_double(var15 * var15 + var17 * var17 + var19 * var19);
                ...
                if (var31 != 0.0D)
                {
                    ...
                    var17 /= var31;
                    var19 /= var31;
                    double var32 = (double)this.worldObj.getBlockDensity(var29, var30.boundingBox);
                    double var33 = (1.0D - var13) * var32;
                    ...
                    {
                        this.field_77288_k.put((EntityPlayer)var30, Vec3.func_72437_a().func_72345_a(var15 * var33, var17 * var33, var19 * var33));
                    }
                }
            }
        }
