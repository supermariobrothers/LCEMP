...
public class WorldServer extends World
{
    ...
    public void tick()
    {
        ...
        SpawnerAnimals.func_77192_a(this, this.spawnHostileMobs, this.spawnPeacefulMobs && this.worldInfo.getWorldTime() % 400L == 0L);
        ...
        this.field_73063_M.updatePlayerInstances();
    ...
    {
        this.field_73068_P = !this.playerEntities.isEmpty();
    ...
    {
        if (this.field_73068_P && !this.isRemote)
        {
            Iterator var1 = this.playerEntities.iterator();
            EntityPlayer var2;
            ...
            if (this.rand.nextInt(16) == 0)
            {
                ...
                if (this.isRaining())
                {
                    ...
                    if (var12.canSpawnLightningBolt())
                    {
                        ...
                        if (var13 != 0)
                        {
                            Block.blocksList[var13].func_71892_f(this, var9 + var5, var11 - 1, var10 + var6);
                        }
                    }
                }
            }
    ...
    {
        if (!this.mcServer.func_71268_U() && (par1Entity instanceof EntityAnimal || par1Entity instanceof EntityWaterMob))
        {
            par1Entity.setDead();
        }

        if (!this.mcServer.func_71220_V() && par1Entity instanceof INpc)
        {
            par1Entity.setDead();
        }
    ...
    protected void initialize(WorldSettings par1WorldSettings)
    {
        ...
        this.func_73052_b(par1WorldSettings);
    ...
    public Explosion newExplosion(Entity par1Entity, double par2, double par4, double par6, float par8, boolean par9)
    {
        ...
        while (var11.hasNext())
        {
            ...
            {
                ((EntityPlayerMP)var12).playerNetServerHandler.sendPacket(new Packet60Explosion(par2, par4, par6, par8, var10.field_77281_g, (Vec3)var10.func_77277_b().get(var12)));
            }
        }
