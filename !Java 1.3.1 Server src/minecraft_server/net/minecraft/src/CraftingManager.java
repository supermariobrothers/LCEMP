...
public class CraftingManager
{
    ...
    private CraftingManager()
    {
        ...
        this.addRecipe(new ItemStack(Block.field_72072_bX, 4), new Object[] {"#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 2)});
        this.addRecipe(new ItemStack(Block.field_72074_bW, 4), new Object[] {"#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 1)});
        this.addRecipe(new ItemStack(Block.field_72070_bY, 4), new Object[] {"#  ", "## ", "###", '#', new ItemStack(Block.planks, 1, 3)});
        ...
        this.addRecipe(new ItemStack(Block.field_72088_bQ, 4), new Object[] {"#  ", "## ", "###", '#', Block.sandStone});
        ...
        this.addRecipe(new ItemStack(Block.field_72064_bT, 2), new Object[] {"I", "S", "#", '#', Block.planks, 'S', Item.stick, 'I', Item.ingotIron});
    ...
    void addRecipe(ItemStack par1ItemStack, Object ... par2ArrayOfObj)
    {
        ...
        {
            Character var15 = (Character)par2ArrayOfObj[var4];
        ...
        this.recipes.add(new ShapedRecipes(var5, var6, var16, par1ItemStack));
    }
    ...
    public ItemStack findMatchingRecipe(InventoryCrafting par1InventoryCrafting)
    {
        ...
        if (var2 == 2 && var3.itemID == var4.itemID && var3.stackSize == 1 && var4.stackSize == 1 && Item.itemsList[var3.itemID].isDamageable())
        {
            ...
            int var13 = var11.getMaxDamage() - var3.getItemDamageForDisplay();
            int var7 = var11.getMaxDamage() - var4.getItemDamageForDisplay();
            int var8 = var13 + var7 + var11.getMaxDamage() * 10 / 100;
        ...
        {
            Iterator var10 = this.recipes.iterator();
            IRecipe var12;
            ...
            do
            {
                ...
                var12 = (IRecipe)var10.next();
            }
            while (!var12.matches(par1InventoryCrafting));
