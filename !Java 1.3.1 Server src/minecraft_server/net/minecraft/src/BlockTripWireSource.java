...
public class BlockTripWireSource extends Block
{
    ...
    public void func_72143_a(World par1World, int par2, int par3, int par4, int par5, int par6, boolean par7, int par8, int par9)
    {
        ...
        boolean var13 = par5 == Block.field_72064_bT.blockID;
        boolean var14 = false;
        ...
        for (var20 = 1; var20 < 42; ++var20)
        {
            ...
            if (var23 == Block.field_72064_bT.blockID)
            {
            ...
            if (var23 != Block.field_72062_bU.blockID && var20 != par8)
            {
                var19[var20] = -1;
                var13 = false;
            }
        ...
        if (var18 > 0)
        {
            ...
            this.func_72146_e(par1World, var21, par3, var22, var23);
            this.func_72145_a(par1World, var21, par3, var22, var13, var14, var11, var12);
        }

        this.func_72145_a(par1World, par2, par3, par4, var13, var14, var11, var12);
        ...
        if (par5 > 0)
        {
            ...
            if (par7)
            {
                this.func_72146_e(par1World, par2, par3, par4, var10);
            }
        }
