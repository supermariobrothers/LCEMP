...
public class AnvilChunkLoader implements IThreadedFileIO, IChunkLoader
{
    ...
    public Chunk loadChunk(World par1World, int par2, int par3) throws IOException
    {
        ...
        synchronized (this.field_75827_c)
        {
            ...
            {
                Iterator var7 = this.field_75828_a.iterator();

                while (var7.hasNext())
                {
                    AnvilChunkLoaderPending var8 = (AnvilChunkLoaderPending)var7.next();

                    if (var8.field_76548_a.equals(var5))
                    {
                        var4 = var8.field_76547_b;
                        break;
                    }
                }
            }
        ...
        return this.func_75822_a(par1World, par2, par3, var4);
    }

    protected Chunk func_75822_a(World par1World, int par2, int par3, NBTTagCompound par4NBTTagCompound)
    {
    ...
    protected void func_75824_a(ChunkCoordIntPair par1ChunkCoordIntPair, NBTTagCompound par2NBTTagCompound)
    {
        ...
        synchronized (this.field_75827_c)
        {
            if (this.field_75826_b.contains(par1ChunkCoordIntPair))
            {
                for (int var4 = 0; var4 < this.field_75828_a.size(); ++var4)
                {
                    if (((AnvilChunkLoaderPending)this.field_75828_a.get(var4)).field_76548_a.equals(par1ChunkCoordIntPair))
                    {
                        this.field_75828_a.set(var4, new AnvilChunkLoaderPending(par1ChunkCoordIntPair, par2NBTTagCompound));
                        return;
                    }
                }
            }

            this.field_75828_a.add(new AnvilChunkLoaderPending(par1ChunkCoordIntPair, par2NBTTagCompound));
            this.field_75826_b.add(par1ChunkCoordIntPair);
    ...
    private void func_75821_a(AnvilChunkLoaderPending par1AnvilChunkLoaderPending) throws IOException
    {
        DataOutputStream var2 = RegionFileCache.getChunkOutputStream(this.chunkSaveLocation, par1AnvilChunkLoaderPending.field_76548_a.chunkXPos, par1AnvilChunkLoaderPending.field_76548_a.chunkZPos);
        CompressedStreamTools.write(par1AnvilChunkLoaderPending.field_76547_b, var2);
        var2.close();
    }
