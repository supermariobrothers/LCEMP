...
public class NoiseGeneratorPerlin extends NoiseGenerator
{
    ...
    public void func_76308_a(double[] par1ArrayOfDouble, double par2, double par4, double par6, int par8, int par9, int par10, double par11, double par13, double par15, double par17)
    {
        int var10001;
        int var19;
        int var22;
